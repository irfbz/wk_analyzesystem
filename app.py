...
if uploaded_files:
    ...
    st.write(f"Player involvement in {action_type} Actions by Result:")
    pivot_table = details.pivot_table(index=['playerShirtNumber', 'playerName'], columns='ActionResultName', aggfunc='size', fill_value=0)
    # 総数のカウントを追加
